...
//	     사람 이름/성별/운동강도 등록"
		 ...
		 Human human2 = new Human("park" , "남성", Define.MEN ,"가벼운 운동 (주 1-3)" ,Define.EASY);
...
//		   사람마다 키/몸무게/나이 등록
		 ...
		 human4.inputStatList(new Stat(158 , 45 , 25));
		 human5.inputStatList(new Stat(165 , 65 , 22));
		 human6.inputStatList(new Stat(160 , 75 , 30));
